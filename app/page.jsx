    ...
    <div className="min-h-screen w-full">
      ...
      <header className="sticky top-0 z-30 backdrop-blur bg-black/30 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          {/* changed to internal smooth scroll */}
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0" aria-hidden>
          <img src="/images/hero-forest.svg" alt="Misty forest" className="h-full w-full object-cover opacity-30" />
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 hover:bg-white/10">
              ...
              {/* changed to smooth scroll */}
              <a href="#reserve" onClick={scrollToReserve} className="mt-6 inline-block btn-primary w-full text-center">Select Essential</a>
            </div>
            ...
            <div className="rounded-3xl border border-brand-gold/40 bg-brand-gold/10 p-6 hover:bg-brand-gold/15">
              ...
              {/* changed to smooth scroll */}
              <a href="#reserve" onClick={scrollToReserve} className="mt-6 inline-block btn-primary w-full text-center">Select Private Indulgence</a>
            </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 hover:bg-white/10">
              ...
              {/* changed to smooth scroll */}
              <a href="#reserve" onClick={scrollToReserve} className="mt-6 inline-block btn-primary w-full text-center">Select VIP Sanctuary</a>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Reserve */}
      {/* NOTE: adding explicit id="reserve" so the helper can find it */}
