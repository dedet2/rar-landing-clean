...
export default function Page() {
  ...
  return (
    <div className="min-h-screen w-full">
      ...
      {/* Hero with photorealistic image + overlay */}
      <section className="relative overflow-hidden">
        <div className="absolute inset-0" aria-hidden>
          <img src="https://images.unsplash.com/photo-1501785888041-af3ef285b470?q=80&w=2000&auto=format&fit=crop" alt="Autumn mountains and lake in Japan" className="h-full w-full object-cover opacity-60" />
          <div className="absolute inset-0 bg-gradient-to-b from-[#3B0A45]/60 via-transparent to-[#0D3B2E]/60" />
        </div>
        ...
        <div className="section">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="rounded-3xl border border-white/10 bg-[#2a241f] p-6 hover:bg-[#342c25]">
              ...
              <a href="#reserve" onClick={selectTier('t1')} className="mt-6 inline-block w-full text-center btn-outline">Inquiry</a>
            ...
            <div className="rounded-3xl border border-[#d6b38a]/50 bg-[#3a2f26] p-6 hover:bg-[#43362c]">
              ...
              <a href="#reserve" onClick={selectTier('t2')} className="mt-6 inline-block w-full text-center btn-outline">Inquiry</a>
            ...
            <div className="rounded-3xl border border-white/10 bg-[#2e2620] p-6 hover:bg-[#382e26]">
              ...
              <a href="#reserve" onClick={selectTier('t3')} className="mt-6 inline-block w-full text-center btn-outline">Inquiry</a>
      ...
      <section className="section py-10">
        <div className="grid md:grid-cols-3 gap-4">
          <div className="img-shell h-56">
            <img src="https://images.unsplash.com/photo-1605859392167-6c2b7b29ea62?q=80&w=1600&auto=format&fit=crop" alt="Kamakura coast" onError={(e)=>{e.currentTarget.src='/images/kamakura_fallback.svg';}} />
            <div className="fallback">Kamakura coast — loading…</div>
          </div>
          <div className="img-shell h-56">
            <img src="https://images.unsplash.com/photo-1549692520-acc6669e2f0c?q=80&w=1600&auto=format&fit=crop" alt="Beppu onsen steam" onError={(e)=>{e.currentTarget.src='/images/beppu_fallback.svg';}} />
            <div className="fallback">Beppu onsen — loading…</div>
          </div>
          <div className="img-shell h-56">
            <img src="https://images.unsplash.com/photo-1536098561742-ca998e48cbcc?q=80&w=1600&auto=format&fit=crop" alt="Miyajima torii gate" onError={(e)=>{e.currentTarget.src='/images/miyajima_fallback.svg';}} />
            <div className="fallback">Miyajima — loading…</div>
          </div>
        </div>
      </section>
